...
class Main extends Application {
  ...
  val button3Css = "-jfx-button-type: FLAT; -fx-background-color: green; -fx-text-fill: white;"
  ...
  def handleClick(event: MouseEvent, link: String = null): Unit = {
    (event.getSource, link) match {
